...
# Not necessary to edit this file if your high and low loras match the naming pattern ending in "_high_noise" and "_low_noise" however in this case it will assume both exist
LORA_REGISTRY = [
